...
#prompt_improv = f"Act as a budgeting advisor. You will be given a question the following prompt: {user_response}"
    ...
    category_prompt = f"Which category does {item_gen} fit into. It must be either Education, Food And Drink, Health And Fitness, Recreation, Fashion And Beauty, Entertainment, Home And Vehicle, Grocery, Travel, or Miscellaneous. Do not print anything else but one of the categories"
...
def gpt_improve_response(category):
    improve_prompt = f"Act as a budgeting advisor for me, I'm spending too much money on {category}, tell me what I can do I reduce my spending in this category. Give me 3 insights with no introduction or ending conclusion. Make each suggestion short (10-15 words). Do not give me anything else. Just the reccomendations. No extra words or whitespaces"
